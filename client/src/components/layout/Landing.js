	...
	return (
		<div>
			<div id="landing" className="landing">
				<div className="dark-overlay">
					<div className="landing-inner">
						<h1 className="x-large">Booking system</h1>
						<p className="lead"></p>
			...
			<div className={`nav-sidebar ${display ? `show-sidebar fade-in` : `hide-sidebar-${count}`}`}>
				<a className={`${activeLink === 3 ? 'active-link' : null} `} href="#contact">
					<i className="far fa-envelope"></i>
				</a>
				<a className={`${activeLink === 2 ? 'active-link' : null} `} href="#services">
					<i className="fas fa-dumbbell"></i>
				</a>
				<a className={`${activeLink === 1 ? 'active-link' : null} `} href="#about">
					<i className="fa fa-about"></i> About
				</a>
				<a href="#landing">
