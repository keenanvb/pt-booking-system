...
const About = () => {
    return (
        <div className="about-container">
            ...
            you towards a more positive, healthy and active lifestyle through physical fitness.</p>
                <p> "Once you start seeing results, it becomes an addiction"</p>
                <p> I just need you to keep pushing and "Be stronger than your strongest excuse"</p>
